...
CREATE OR ALTER TRIGGER TG_CALCUTE_TTPRICE_INCURRED_COST_INSERT
...
CREATE OR ALTER TRIGGER TG_CALCUTE_TTPRICE_INCURRED_COST_UDPATE
...
CREATE OR ALTER TRIGGER TG_CALCUTE_TTPRICE_INCURRED_COST_DELETE
ON INCURRED_COSTS AFTER UPDATE
AS
BEGIN
	IF (UPDATE(STATUS_IC))
...
CREATE OR ALTER TRIGGER TG_UPDATE_INVENTORY_QUANTITY_BY_INCURRED_COST_INSERT
ON INCURRED_COSTS AFTER INSERT
AS
BEGIN
	DECLARE 

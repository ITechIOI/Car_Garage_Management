...
----Stored procedure for Card Repair
CREATE OR ALTER PROCEDURE USP_LOAD_REPAIR_CARD_DETAILS
@ID_REC CHAR(10), @NUMBER_PLATES VARCHAR(15), @RECEPTION_DATE SMALLDATETIME
AS
BEGIN
	SELECT RPD.REPAIR_DESCRIPTION, CC.NAME_COM, CD.CUR_PRICE,RPD.COM_QUANTITY, CD.WAGE, RPD.TOTAL_PRICE, RPB.TOTAL_PAYMENT 
	...
	WHERE
		...
		RF.NUMBER_PLATES = @NUMBER_PLATES AND
		RF.RECEPTION_DATE = @RECEPTION_DATE AND

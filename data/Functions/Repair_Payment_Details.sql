...
AS
BEGIN
	SELECT RF.ID_REC, RPB.ID_BILL, RPD.RPD_ORDINAL_NUM, RF.NUMBER_PLATES, RF.RECEPTION_DATE, RPD.REPAIR_DESCRIPTION, CC.NAME_COM, CD.CUR_PRICE,RPD.COM_QUANTITY, CD.WAGE, RPD.TOTAL_PRICE, RPB.TOTAL_PAYMENT 

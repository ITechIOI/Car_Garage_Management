...
BEGIN
	...
	INSERT REPAIR_PAYMENT_BILL (ID_BILL, ID_REC,COMPLETION_DATE, STATUS_BILL) VALUES ('BIL' + CAST(@MAX_ID AS CHAR(7)), @ID_REC, '1/1/1900', 0)
END
GO
...
CREATE OR ALTER PROCEDURE USP_DELETE_REPAIR_CAR_DETAILS
@RPD_ORDINAL_NUM INT
AS
BEGIN
	UPDATE REPAIR_PAYMENT_DETAILS
...
CREATE OR ALTER PROC DELETEBILL
@idBill CHAR(10)
AS
BEGIN
	UPDATE REPAIR_PAYMENT_DETAILS SET STATUS_RPD = 1 WHERE ID_BILL = @idBill
	UPDATE REPAIR_PAYMENT_BILL SET STATUS_BILL=1 WHERE ID_BILL = @idBill
END
